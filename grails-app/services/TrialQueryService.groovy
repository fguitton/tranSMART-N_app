...
class TrialQueryService {
    ...
    def querySOLRTrialAnalysis(params, List sessionFilter) {
        ...
        def results = org.transmart.biomart.BioAssayAnalysis.executeQuery("select b.id, b.shortDescription, b.longDescription, b.name, b.assayDataType " +
        ...
        def timeCourseAnalyses = org.transmart.biomart.BioAnalysisAttributeLineage.executeQuery("select b1.bioAnalysisAttribute.bioAssayAnalysisID from BioAnalysisAttributeLineage b1" +
